...
- Search: "{seed_company} {address} {postcode} gov.co.uk" (literal text 'gov.co.uk')
- Open Companies House (find-and-update.company-information.service.gov.uk).
- Capture:
...
1) Open Google Business Profile for "{{company_name}} {postcode}":
   - capture main phone, follow website if present.
2) On the official website (strict navigation order):
